...
public class ReverseControlFlowGraph implements Graph {
  ...
  public ReverseControlFlowGraph(ControlFlowGraph cfg) {
    this.cfg = cfg;
  }
  ...
  @Override
  public Iterable<BasicBlock> getSuccessors(BasicBlock n) {
    return n.getPredecessors();
  }

  @Override
  public Iterable<BasicBlock> getPredecessors(BasicBlock n) {
