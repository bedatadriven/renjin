...
/**
 * Translates a call to function closure whose identity is known at compile time.
 */
public class ClosureCallTranslator extends FunctionCallTranslator {
  ...
  public Expression translateToSetterExpression(IRBodyBuilder builder, TranslationContext context, FunctionCall getterCall, Expression rhs) {
    ...
    return new ClosureCall(builder.getRuntimeState(), getterCall, function, functionName, setterArguments);
  }
