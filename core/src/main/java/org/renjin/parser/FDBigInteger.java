 ...
 *
 * <p>This class is supports the
 * {@link NumericLiterals#parseDouble(CharSequence, int, int, char, boolean)} routine
 * and is included here to avoid a dependency on an internal JDK class.</p>
 *
 */
/*@ spec_bigint_math @*/ class FDBigInteger {
