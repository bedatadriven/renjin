...
public class Native {
  ...
  /**
   * Provides thread-safe access to the current context for code written against the GNU R API.
   */
  ...
  public static Context getContext() {
    ...
    if(context == null) {
      throw new IllegalStateException("No Renjin context set for this thread.");
    }
    return context;
  }
