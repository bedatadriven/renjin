 ...
 * @version $Id$
 */
public class ExtendedPattern implements Serializable, Pattern {
    /**
     ...
     * @see RECompiler
     */
    public ExtendedPattern(String pattern) throws RESyntaxException
    {
   ...
   * @param ignoreCase
   */
    public ExtendedPattern(String pattern, boolean ignoreCase) throws RESyntaxException {
    ...
    public Pattern ignoreCase(boolean ignore) {
      if(ignore) {
        setMatchFlags(MATCH_CASEINDEPENDENT);
      }
      return this;
     ...
     * @see RECompiler
     */
    public ExtendedPattern(String pattern, int matchFlags) throws RESyntaxException
    {
     ...
     * @see REProgram
     */
    public ExtendedPattern(REProgram program, int matchFlags)
    {
        setProgram(program);
     ...
     */
    public ExtendedPattern(REProgram program)
    {
