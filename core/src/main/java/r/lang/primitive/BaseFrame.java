...
import r.lang.*;
import r.lang.primitive.special.*;
...
public class BaseFrame implements Environment.Frame {
  ...
  private void installBuiltins() {
    ...
    add("while", new WhileFunction());
    add("for", new ForFunction());
    add("repeat", new RepeatFunction());
    add("break", new BreakFunction());
    add("next", new NextFunction());
    add("return", new ReturnFunction());
    ...
    add("function", new ClosureFunction());
    ...
    add(".Internal", new InternalFunction());
    add("on.exit", new OnExitFunction());
...
/* these are group generic and so need to eval args */
    f("==", Comparison.class, EQOP, 1, 2, PP_BINARY, PREC_COMPARE, 0);
    f("!=", Comparison.class, NEOP, 1, 2, PP_BINARY, PREC_COMPARE, 0);
    f("<", Comparison.class, LTOP, 1, 2, PP_BINARY, PREC_COMPARE, 0);
    f("<=", Comparison.class, LEOP, 1, 2, PP_BINARY, PREC_COMPARE, 0);
    f(">=", Comparison.class, GEOP, 1, 2, PP_BINARY, PREC_COMPARE, 0);
    f(">", Comparison.class, GTOP, 1, 2, PP_BINARY, PREC_COMPARE, 0);
    f("&", Comparison.class,  1, 1, 2, PP_BINARY, PREC_AND, 0);
    f("|", Comparison.class, 2, 1, 2, PP_BINARY, PREC_OR, 0);
    f("!", Comparison.class, 3, 1, 1, PP_UNARY, PREC_NOT, 0);
...
/* String Manipulation */
    ...
    f("make.unique", /*makeunique*/ null, 0, 11, 2);
...
/* Miscellaneous */
    ...
    f("substitute", Evaluation.class, 0, 0, -1);
