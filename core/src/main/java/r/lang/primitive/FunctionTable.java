...
public class FunctionTable {
  ...
  public static final Entry[] ENTRIES = new Entry[]{
      ...
      f("<<-", Evaluation.class, 2, 100, -1, PP_ASSIGN2, PREC_LEFT, 1),
 ...
 * ---------	-------		------	----	-----	-------      ----------	----------*/
      ...
      f("unlist", Combine.class, 0, 11, 3, PP_FUNCALL, PREC_FN, 0),
      f("cbind", /*bind*/ null, 1, 10, -1, PP_FUNCALL, PREC_FN, 0),
      f("rbind", Combine.class, 2, 10, -1, PP_FUNCALL, PREC_FN, 0),
      ...
      f("attributes", Types.class, 0, 1, 1, PP_FUNCALL, PREC_FN, 0),
      ...
      f("unique", Match.class, 1, 11, 3, PP_FUNCALL, PREC_FN, 0),
...
/* Type coercion */
      ...
      f("as.vector", Types.class, 0, 11, 2, PP_FUNCALL, PREC_FN, 0),
      f("paste", Text.class, 0, 11, 3, PP_FUNCALL, PREC_FN, 0),
      f("file.path", Text.class, 0, 11, 2, PP_FUNCALL, PREC_FN, 0),
...
/* String Manipulation */
      ...
      f("grepl", Text.class, 1, 11, 9, PP_FUNCALL, PREC_FN, 0),
      f("sub", Text.class, 0, 11, 8, PP_FUNCALL, PREC_FN, 0),
      f("gsub", Text.class, 1, 11, 8, PP_FUNCALL, PREC_FN, 0),
...
/* Miscellaneous */
      ...
      f("Version", System.class, 0, 11, 0, PP_FUNCALL, PREC_FN, 0),
      f("machine", /*machine*/ null, 0, 11, 0, PP_FUNCALL, PREC_FN, 0),
      f("commandArgs", System.class, 0, 11, 0, PP_FUNCALL, PREC_FN, 0),
      ...
      f("interactive", Evaluation.class, 0, 0, 0, PP_FUNCALL, PREC_FN, 0),
      ...
      f("rep.int", Sequences.class, 0, 11, 2, PP_FUNCALL, PREC_FN, 0),
      ...
      f("ls", Types.class, 1, 11, 2, PP_FUNCALL, PREC_FN, 0),
      ...
      f("nargs", Evaluation.class, 1, 0, 0, PP_FUNCALL, PREC_FN, 0),
      ...
      f("options", Types.class, 0, 211, 1, PP_FUNCALL, PREC_FN, 0),
      ...
      f("islistfactor",  Types.class, 0, 11, 2, PP_FUNCALL, PREC_FN, 0),
...
/* Functions To Interact with the Operating System */
      ...
      f("list.files", System.class, 0, 11, 6, PP_FUNCALL, PREC_FN, 0),
      ...
      f("Sys.getenv", System.class, 0, 11, 2, PP_FUNCALL, PREC_FN, 0),
      f("Sys.setenv", System.class, 0, 111, 2, PP_FUNCALL, PREC_FN, 0),
      ...
      f("basename", System.class, 0, 11, 1, PP_FUNCALL, PREC_FN, 0),
      f("dirname", System.class, 0, 11, 1, PP_FUNCALL, PREC_FN, 0),
      ...
      f("Sys.getlocale", System.class, 0, 11, 1, PP_FUNCALL, PREC_FN, 0),
...
/* Objects */
      ...
      f("UseMethod", Evaluation.class, 0, 200, -1, PP_FUNCALL, PREC_FN, 0),
