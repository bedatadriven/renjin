...
public class FunctionTable {
  ...
  public static final Entry[] ENTRIES = new Entry[]{
      ...
      f("bindtextdomain", /*bindtextdomain*/ null, 0, 11, 2, PP_FUNCALL, PREC_FN, 0),
      ...
      f(".signalCondition", /*signalCondition*/ null, 0, 11, 3, PP_FUNCALL, PREC_FN, 0),
      ...
      f("$", /*subset3*/ null, 3, 0, 2, PP_DOLLAR, PREC_DOLLAR, 0),
      ...
      f("$<-", /*subassign3*/ null, 1, 0, 3, PP_SUBASS, PREC_LEFT, 1),
      ...
      f("makeLazy", /*makelazy*/ null, 0, 111, 5, PP_FUNCALL, PREC_FN, 0),
 ...
 * ---------	-------		------	----	-----	-------      ----------	----------*/
      ...
      f("attr", /*attr*/ null, 0, 1, -1, PP_FUNCALL, PREC_FN, 0),
      f("attr<-", /*attrgets*/ null, 0, 1, 3, PP_FUNCALL, PREC_LEFT, 1),
      ...
      f("get", /*get*/ null, 1, 11, 4, PP_FUNCALL, PREC_FN, 0),
      f("mget", /*mget*/ null, 1, 11, 5, PP_FUNCALL, PREC_FN, 0),
      f("exists", /*get*/ null, 0, 11, 4, PP_FUNCALL, PREC_FN, 0),
      f("assign", /*assign*/ null, 0, 111, 4, PP_FUNCALL, PREC_FN, 0),
...
/* Miscellaneous */
      ...
      f("unserializeFromConn", /*unserializeFromConn*/ null, 0, 111, 2, PP_FUNCALL, PREC_FN, 0),
      ...
      f("substitute", /*substitute*/ null, 0, 0, -1, PP_FUNCALL, PREC_FN, 0),
      f("quote", /*quote*/ null, 0, 0, 1, PP_FUNCALL, PREC_FN, 0),
      ...
      f("baseenv", /*baseenv*/ null, 0, 1, 0, PP_FUNCALL, PREC_FN, 0),
      f("globalenv", /*globalenv*/ null, 0, 1, 0, PP_FUNCALL, PREC_FN, 0),
      f("environment", /*envir*/ null, 0, 11, 1, PP_FUNCALL, PREC_FN, 0),
      ...
      f("new.env", /*newenv*/ null, 0, 11, 3, PP_FUNCALL, PREC_FN, 0),
      f("parent.env", /*parentenv*/ null, 0, 11, 1, PP_FUNCALL, PREC_FN, 0),
      f("parent.env<-", /*parentenvgets*/ null, 0, 11, 2, PP_FUNCALL, PREC_LEFT, 1),
...
/* Functions To Interact with the Operating System */
      ...
      f("file.info", /*fileinfo*/ null, 0, 11, 1, PP_FUNCALL, PREC_FN, 0),
      ...
      f("R.home", /*Rhome*/ null, 0, 11, 0, PP_FUNCALL, PREC_FN, 0),
...
/* Objects */
      f("inherits", /*inherits*/ null, 0, 11, 3, PP_FUNCALL, PREC_FN, 0),
...
/* date-time manipulations */
      ...
      f("strptime", /*strptime*/ null, 0, 11, 3, PP_FUNCALL, PREC_FN, 0),
...
/* Connections */
      ...
      f("close", /*close*/ null, 0, 11, 2, PP_FUNCALL, PREC_FN, 0),
      ...
      f("gzfile", /*gzfile*/ null, 0, 11, 4, PP_FUNCALL, PREC_FN, 0),
