...
public class FunctionTable {
  ...
  public static final Entry[] ENTRIES = new Entry[]{
      ...
      f("<-", Evaluation.class, "assignLeft", 1, 100, -1, PP_ASSIGN, PREC_LEFT, 1),
      ...
      f("(", Evaluation.class, "paren", 0, 1, 1, PP_PAREN, PREC_FN, 0),
      ...
      f("[[", Types.class, "subset2", 2, 0, -1, PP_SUBSET, PREC_SUBSET, 0),
