...
public class GroupGenericFunction extends BuiltinFunction {

  public GroupGenericFunction(BaseFrame.Entry functionEntry) {
    super(functionEntry);
  }
//
//  public SEXP dispatch(String group, FunctionCall call, PairList args) {
...
//      nargs = 1;
//
//    if (nargs == 1 && ! args.getElementAsSEXP(0).isObject())
//      return null;
//
