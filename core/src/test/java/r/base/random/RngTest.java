...
public class RngTest extends EvalTestCase {
  ...
  public void rsignrank() {
    eval("set.seed(12345, 'Mersenne-Twister','I')");
    assertThat(eval("mean(rsignrank(1000,10))").asReal(), closeTo(27.552, DELTA));
  }
  ...
  public void rhyper() {
    eval("set.seed(12345, 'Mersenne-Twister','I')");
    assertThat(eval("mean(rhyper(10000,17,16,13))").asReal(), closeTo(6.375, DELTA));
  }

   @Test
   public void rnorm() {
     eval("set.seed(12345, 'Mersenne-Twister','I')");
     assertThat(eval("mean(rnorm(10000,0,1))").asReal(), closeTo(0.0, 0.1));
   }
}
