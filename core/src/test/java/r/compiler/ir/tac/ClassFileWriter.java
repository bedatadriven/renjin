...
public class ClassFileWriter {
  ...
  public byte[] toByteCode (String className) throws Exception {
    ...
    {
      mv = cw.visitMethod(ACC_PUBLIC, "eval", "(Lr/lang/Context;Lr/lang/Environment;)Lr/lang/SEXP;", null, null);
      mv.visitCode();
      Label l0 = new Label();
      mv.visitLabel(l0);
      ...
      Label l2 = new Label();
      mv.visitLabel(l2);
      mv.visitMethodInsn(INVOKESTATIC, "r/base/primitives/R$primitive$_$43$_", "doApply", "(Lr/lang/Context;Lr/lang/Environment;Lr/lang/SEXP;Lr/lang/SEXP;)Lr/lang/SEXP;");
