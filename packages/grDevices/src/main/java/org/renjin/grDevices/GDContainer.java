...
/**
 * <code>GDContainer</code> is the minimal interface that has to be implemented by classes that are used as back-ends
 * for JavaGD. The interface feeds graphics objects to the instance which are then free to use them for any purpose
