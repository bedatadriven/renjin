...
test.as.name.30 <- function() assertThat(as.name(list(3, "a", structure(list("b", z = list(TRUE, "c")), .Names = c("", "z")))), throwsError())
test.as.name.31 <- function() assertThat(as.name(structure(list(`NA` = 1, 2, b = 3), .Names = c(NA, "", "b"))), throwsError())
test.as.name.32 <- function() assertThat(as.name(pairlist(41, "a", 21L)), throwsError())
test.as.name.33 <- function() assertThat(as.name(pairlist(a = 41, 42)), throwsError())
test.as.name.34 <- function() assertThat(as.name(pairlist(a = 41, NULL)), throwsError())
test.as.name.35 <- function() assertThat(as.name(structure(1:12, .Dim = 3:4)), identicalTo(as.name("1")))
test.as.name.36 <- function() assertThat(as.name(structure(1:12, .Dim = 3:4, .Dimnames = structure(list(    x = c("a", "b", "c"), y = c("d", "e", "f", "g")), .Names = c("x", "y")))), identicalTo(as.name("1")))
...
test.as.name.39 <- function() assertThat(as.name(structure(1:3, .Dim = 3L, .Dimnames = structure(list(    z = c("a", "b", "c")), .Names = "z"))), identicalTo(as.name("1")))
...
test.as.name.54 <- function() assertThat(as.name(structure(list(1L, "bar"), class = "bar")), throwsError())
