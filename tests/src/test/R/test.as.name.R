...
test.as.name.29 <- function() assertThat(as.name(list(3, "a", structure(list("b", z = list(TRUE, "c")), .Names = c("", "z")))), throwsError())
test.as.name.30 <- function() assertThat(as.name(structure(list(`NA` = 1, 2, b = 3), .Names = c(NA, "", "b"))), throwsError())
test.as.name.31 <- function() assertThat(as.name(pairlist(41, "a", 21L)), throwsError())
test.as.name.32 <- function() assertThat(as.name(pairlist(a = 41, 42)), throwsError())
test.as.name.33 <- function() assertThat(as.name(pairlist(a = 41, NULL)), throwsError())
test.as.name.34 <- function() assertThat(as.name(structure(1:12, .Dim = 3:4)), identicalTo(as.name("1")))
test.as.name.35 <- function() assertThat(as.name(structure(1:12, .Dim = 3:4, .Dimnames = structure(list(    x = c("a", "b", "c"), y = c("d", "e", "f", "g")), .Names = c("x", "y")))), identicalTo(as.name("1")))
test.as.name.36 <- function() assertThat(as.name(structure(1:3, rando.attrib = 941L)), identicalTo(as.name("1")))
test.as.name.37 <- function() assertThat(as.name(structure(1:3, .Dim = 3L, .Dimnames = list(c("a", "b", "c")))), identicalTo(as.name("1")))
test.as.name.38 <- function() assertThat(as.name(structure(1:3, .Dim = 3L, .Dimnames = structure(list(    z = c("a", "b", "c")), .Names = "z"))), identicalTo(as.name("1")))
test.as.name.39 <- function() assertThat(as.name(structure(list("foo"), class = "foo")), identicalTo(99))
test.as.name.40 <- function() assertThat(as.name(structure(list("bar"), class = "foo")), identicalTo(99))
test.as.name.41 <- function() assertThat(as.name(quote(xyz)), identicalTo(as.name("xyz")))
test.as.name.42 <- function() assertThat(as.name(quote(sin(3.14))), throwsError())
test.as.name.43 <- function() assertThat(as.name("NaN"), identicalTo(as.name("NaN")))
test.as.name.44 <- function() assertThat(as.name("NABOOM!"), identicalTo(as.name("NABOOM!")))
test.as.name.45 <- function() assertThat(as.name("NaNaNabooboo"), identicalTo(as.name("NaNaNabooboo")))
test.as.name.46 <- function() assertThat(as.name("-Inf"), identicalTo(as.name("-Inf")))
test.as.name.47 <- function() assertThat(as.name("+Infinity"), identicalTo(as.name("+Infinity")))
test.as.name.48 <- function() assertThat(as.name("Infinity and beyond!"), identicalTo(as.name("Infinity and beyond!")))
test.as.name.49 <- function() assertThat(as.name("Infi"), identicalTo(as.name("Infi")))
test.as.name.50 <- function() assertThat(as.name("0.03f"), identicalTo(as.name("0.03f")))
test.as.name.51 <- function() assertThat(as.name("  0.0330   "), identicalTo(as.name("  0.0330   ")))
test.as.name.52 <- function() assertThat(as.name(structure("foo", class = "foo")), identicalTo(99))
test.as.name.53 <- function() assertThat(as.name(structure(list(1L, "bar"), class = "bar")), throwsError())
