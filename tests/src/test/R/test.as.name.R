...
test.as.name.32 <- function() assertThat(as.name(structure(list("foo"), class = "foo")), identicalTo(99, tol = 0.000100))
test.as.name.33 <- function() assertThat(as.name(structure(list("bar"), class = "foo")), identicalTo(99, tol = 0.000100))
...
test.as.name.36 <- function() assertThat(as.name(structure("foo", class = "foo")), identicalTo(99))
