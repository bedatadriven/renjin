...
test.as.name.43 <- function() assertThat(as.name(structure("foo", class = "foo")), identicalTo(99))
test.as.name.44 <- function() assertThat(as.name(structure(list(1L, "bar"), class = "bar")), throwsError())
