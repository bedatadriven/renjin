...
test.expm1.32 <- function() assertThat(expm1(Inf), identicalTo(Inf))
test.expm1.33 <- function() assertThat(expm1(-Inf), identicalTo(-1))
...
test.expm1.42 <- function() assertThat(expm1(structure(0, rando.attr = 4L)), identicalTo(structure(0, rando.attr = 4L)))
test.expm1.43 <- function() assertThat(expm1(structure(0, class = "zinga")), identicalTo(structure(0, class = "zinga")))
