...
assertThat(graphics:::hist.default(breaks=c(100, 300, 500, 700),plot=FALSE,x=structure(c(112, 118, 132, 129, 121, 135, 148, 148, 136, 119, 
...
,  identicalTo( expected[-5], tol = 1e-6 ) )
