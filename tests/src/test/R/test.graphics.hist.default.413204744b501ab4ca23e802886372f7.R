...
assertThat(graphics:::hist.default(border="blue",breaks=5,col="green",main="Histogram for Air Passengers",plot=FALSE,x=structure(c(112, 118, 132, 129, 121, 135, 148, 148, 136, 119, 
...
508, 461, 390, 432), .Tsp = c(1949, 1960.91666666667, 12), class = "ts"),xlab="Passengers",xlim=c(100, 700),1)[-5]
