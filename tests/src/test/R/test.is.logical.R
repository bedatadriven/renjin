...
test.is.logical.29 <- function() assertThat(is.logical(list(3, "a", structure(list("b", z = list(TRUE, "c")), .Names = c("", "z")))), identicalTo(FALSE))
test.is.logical.30 <- function() assertThat(is.logical(structure(list(`NA` = 1, 2, b = 3), .Names = c(NA, "", "b"))), identicalTo(FALSE))
test.is.logical.31 <- function() assertThat(is.logical(pairlist(41, "a", 21L)), identicalTo(FALSE))
test.is.logical.32 <- function() assertThat(is.logical(pairlist(a = 41, 42)), identicalTo(FALSE))
test.is.logical.33 <- function() assertThat(is.logical(pairlist(a = 41, NULL)), identicalTo(FALSE))
test.is.logical.34 <- function() assertThat(is.logical(structure(1:12, .Dim = 3:4)), identicalTo(FALSE))
test.is.logical.35 <- function() assertThat(is.logical(structure(1:12, .Dim = 3:4, .Dimnames = structure(list(    x = c("a", "b", "c"), y = c("d", "e", "f", "g")), .Names = c("x", "y")))), identicalTo(FALSE))
test.is.logical.36 <- function() assertThat(is.logical(structure(1:3, rando.attrib = 941L)), identicalTo(FALSE))
test.is.logical.37 <- function() assertThat(is.logical(structure(1:3, .Dim = 3L, .Dimnames = list(c("a", "b", "c")))), identicalTo(FALSE))
test.is.logical.38 <- function() assertThat(is.logical(structure(1:3, .Dim = 3L, .Dimnames = structure(list(    z = c("a", "b", "c")), .Names = "z"))), identicalTo(FALSE))
test.is.logical.39 <- function() assertThat(is.logical(structure(list("foo"), class = "foo")), identicalTo(FALSE))
test.is.logical.40 <- function() assertThat(is.logical(structure(list("bar"), class = "foo")), identicalTo(FALSE))
test.is.logical.41 <- function() assertThat(is.logical(quote(xyz)), identicalTo(FALSE))
test.is.logical.42 <- function() assertThat(is.logical(quote(sin(3.14))), identicalTo(FALSE))
test.is.logical.43 <- function() assertThat(is.logical("NaN"), identicalTo(FALSE))
test.is.logical.44 <- function() assertThat(is.logical("NABOOM!"), identicalTo(FALSE))
test.is.logical.45 <- function() assertThat(is.logical("NaNaNabooboo"), identicalTo(FALSE))
test.is.logical.46 <- function() assertThat(is.logical("-Inf"), identicalTo(FALSE))
test.is.logical.47 <- function() assertThat(is.logical("+Infinity"), identicalTo(FALSE))
test.is.logical.48 <- function() assertThat(is.logical("Infinity and beyond!"), identicalTo(FALSE))
test.is.logical.49 <- function() assertThat(is.logical("Infi"), identicalTo(FALSE))
test.is.logical.50 <- function() assertThat(is.logical("0.03f"), identicalTo(FALSE))
test.is.logical.51 <- function() assertThat(is.logical("  0.0330   "), identicalTo(FALSE))
test.is.logical.52 <- function() assertThat(is.logical(structure("foo", class = "foo")), identicalTo(FALSE))
test.is.logical.53 <- function() assertThat(is.logical(structure(list(1L, "bar"), class = "bar")), identicalTo(FALSE))
