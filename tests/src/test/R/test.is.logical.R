...
test.is.logical.30 <- function() assertThat(is.logical(list(3, "a", structure(list("b", z = list(TRUE, "c")), .Names = c("", "z")))), identicalTo(FALSE))
test.is.logical.31 <- function() assertThat(is.logical(structure(list(`NA` = 1, 2, b = 3), .Names = c(NA, "", "b"))), identicalTo(FALSE))
test.is.logical.32 <- function() assertThat(is.logical(pairlist(41, "a", 21L)), identicalTo(FALSE))
test.is.logical.33 <- function() assertThat(is.logical(pairlist(a = 41, 42)), identicalTo(FALSE))
test.is.logical.34 <- function() assertThat(is.logical(pairlist(a = 41, NULL)), identicalTo(FALSE))
test.is.logical.35 <- function() assertThat(is.logical(structure(1:12, .Dim = 3:4)), identicalTo(FALSE))
test.is.logical.36 <- function() assertThat(is.logical(structure(1:12, .Dim = 3:4, .Dimnames = structure(list(    x = c("a", "b", "c"), y = c("d", "e", "f", "g")), .Names = c("x", "y")))), identicalTo(FALSE))
...
test.is.logical.39 <- function() assertThat(is.logical(structure(1:3, .Dim = 3L, .Dimnames = structure(list(    z = c("a", "b", "c")), .Names = "z"))), identicalTo(FALSE))
