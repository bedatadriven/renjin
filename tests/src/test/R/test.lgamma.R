...
test.lgamma.32 <- function() assertThat(lgamma(Inf), identicalTo(Inf))
...
test.lgamma.40 <- function() assertThat(lgamma(structure(c(1, 2), .Names = c("x", ""))), identicalTo(structure(c(0, 0), .Names = c("x", ""))))
...
test.lgamma.42 <- function() assertThat(lgamma(structure(0, rando.attr = 4L)), identicalTo(structure(Inf, rando.attr = 4L)))
test.lgamma.43 <- function() assertThat(lgamma(structure(0, class = "zinga")), identicalTo(structure(Inf, class = "zinga")))
