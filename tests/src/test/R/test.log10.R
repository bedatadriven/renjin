...
test.log10.32 <- function() assertThat(log10(Inf), identicalTo(Inf))
test.log10.33 <- function() assertThat(log10(-Inf), identicalTo(NaN))
...
test.log10.42 <- function() assertThat(log10(structure(0, rando.attr = 4L)), identicalTo(structure(-Inf, rando.attr = 4L)))
test.log10.43 <- function() assertThat(log10(structure(0, class = "zinga")), identicalTo(structure(-Inf, class = "zinga")))
