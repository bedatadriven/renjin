 ...
 */
public class FixedArrayTypeStrategy implements ArrayTypeStrategy<ArrayExpr> {
  ...
  public FixedArrayTypeStrategy(GimpleArrayType arrayType, ValueFunction elementValueFunction) {
    this(arrayType, arrayType.getElementCount(), elementValueFunction);
  }

  public FixedArrayTypeStrategy(GimpleArrayType arrayType, int totalArrayLength, ValueFunction elementValueFunction) {
    this.arrayType = arrayType;
    this.elementValueFunction = elementValueFunction;
    this.arrayLength = totalArrayLength;
    this.arrayValueFunction = new FixedArrayValueFunction(arrayType, elementValueFunction);
  }
  ...
  public ArrayTypeStrategy arrayOf(GimpleArrayType arrayType) {
    ...
    if(arrayType.isStatic()) {
      return new FixedArrayTypeStrategy(arrayType, arrayLength * arrayType.getElementCount(), arrayValueFunction);
  ...
  public FieldStrategy fieldGenerator(Type className, String fieldName) {
    return new FixedArrayField(className, fieldName, arrayLength, elementValueFunction);
  }
