...
//
//  static final double gamma_coeff[] =
//      {
...
//
//
//  private static int NCOEFF = gamma_coeff.length;
//
////
////  #if __GNUC__ >= 3
...
////      #endif
//
//  public static boolean __glibc_unlikely(int condition) {
//    return condition != 0;
//  }
//
//  public static boolean __glibc_unlikely(boolean condition) {
//    return condition;
//  }
//
//
//  public static boolean __glibc_likely(int condition) {
//    return condition != 0;
//  }
//  
...
//
//  public static double gamma_positive (double x, int exp2_adj[]) {
//    int local_signgam;
//    if (x < 0.5)
//    {
//      exp2_adj[0] = 0;
//      return Math.exp(__ieee754_lgamma_r(x + 1, & local_signgam)) / x;
//    }
//    else if (x <= 1.5)
//    {
//      exp2_adj[0] = 0;
//      return __ieee754_exp (__ieee754_gamma_r (x, &local_signgam));
//    }
//    else if (x < 6.5)
//    {
//      /* Adjust into the range for using exp (lgamma).  */
//      exp2_adj[0] = 0;
//      double n = Math.ceil(x - 1.5);
//      double x_adj = x - n;
//      double eps;
//      double prod = __gamma_product (x_adj, 0, n, &eps);
//      return (Math.exp(__ieee754_gamma_r(x_adj, & local_signgam))
//          * prod * (1.0 + eps));
//    }
//    else
//    {
...
//        x_adj_mant *= 2.0;
//      }
//      exp2_adj[0] = x_adj_log2 * (int) x_adj_int;
//      double ret = (Math.pow (x_adj_mant, x_adj)
//          * __ieee754_exp2 (x_adj_log2 * x_adj_frac)
//          * Math.exp (-x_adj)
//          * Math.sqrt (2 * M_PI / x_adj)
//          / prod);
...
//  }
//
//  public static double __ieee754_gamma_r (double x, int signgamp[])
//  {
//    int hx;
//    int lx;
//    double ret;
...
//    lx = (int)xbits; // top bits are discarded
//    hx = Integer. Double.doubleToRawLongBits(hx);
...
//      return (x - x) / (x - x);
//    }
//    if (__glibc_unlikely ( hx == 0xfff00000 && lx == 0))
//    {
...
//  }
//
//  private static double __copysign(double x, double y) {
